...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Notejam: <%=titulo%></title>
	<meta name="description" content="Tela para edição de notas">
...
<body>
  <div class="container">
    ...
    <%=mensagem%>
      <form class="note" action="/diego.silva/notejam-vbs-asp-ado/asp/controller/notes/alter-a-note.asp" method="POST">
