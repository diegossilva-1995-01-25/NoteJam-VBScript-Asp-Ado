...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Notejam: Forgot password?</title>
	<meta name="description" content="Tela exibida para gerar nova senha">
...
<body>
  <div class="container">
    ...
    <div class="sixteen columns">
      <h1 class="bold-header"><a href="signin.asp" class="header">note<span class="jam">jam:</span></a> <span> Forgot password?</span></h1>
    </div>
    <div class="sixteen columns content-area">
    <%=mensagem%>
      <form class="offset-by-six sign-in" action="/diego.silva/notejam-vbs-asp-ado/asp/controller/login/forgot.asp">
